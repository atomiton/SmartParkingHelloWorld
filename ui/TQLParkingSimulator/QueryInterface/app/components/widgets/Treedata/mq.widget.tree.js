/**
 * @name treecontrol
 * @description tree angularjs widget based on ngmodules tree directive.
 *
 * @requires    angular.min.js, angular-tree-control.js
 *              
 * @example given the directive such as this below:
 ...
 *  === Attributes ===
 *      class            : customized styling
 *      tree-model       : tree data structure
 *      options          : customization option for the tree, refer link http://ngmodules.org/modules/angular-tree-control for more details.
 *      onSelection      : shows the currently selected node.
 *      employee,age     : names for the tree hierarchy, customize on UI based on the requirement.
 * @link http://localhost:<port_number>/common/widget/tree/test.html
 *
 * Related documents for angular tree structure
 * @see http://ngmodules.org/modules/angular-tree-control
 *
 */
(function ( angular ) {
    'use strict';
