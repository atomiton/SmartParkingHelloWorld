    ...
    return {
        ...
        register: function (eventName, subscriber) {
            ...
            if (!this.getSubscriber(event, subscriber.name)) {
                ...
                // --START-- this code was added by: Manasi S....
                /*if(subscriber.subscriberScope){
                	subscriber.subscriberScope.$watch('queryText',function(newVal,oldVal){
                		console.log("------------------- " );
                		console.log(newVal);
                	});
                ...
                //--END-- this code was added by: Manasi S....
            } else {
            ...
            if (event) {
                event.subscribers.forEach(function (item) {
                    ...
                    if (item.handler) {
                    	...
                    	//--START-- this code was added by: Manasi S....
                    	/*console.log(item.subscriberScope);
                    	if(item.subscriberScope){
                    		
                    		item.subscriberScope.handler(eventData,item.subscriberScope);
                    	}else {
                    		item.handler(eventData);
                    	}*/
                    	//--END-- this code was added by: Manasi S....
